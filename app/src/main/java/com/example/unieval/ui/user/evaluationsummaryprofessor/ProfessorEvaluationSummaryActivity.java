package com.example.unieval.ui.user.evaluationsummaryprofessor;
...
import com.example.unieval.databinding.ActivityProfessorEvaluationSummaryBinding;
...
public class ProfessorEvaluationSummaryActivity extends AppCompatActivity {

    ActivityProfessorEvaluationSummaryBinding binding;
    String userType;
    List<Integer> selectedIndex;
    List<String> allCriteria;
    String researchTitle, universityId;
    int criteriaScore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_professor_evaluation_summary);
        ...
        binding.reportToolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.view_uni_info) {
                    Intent i = new Intent(ProfessorEvaluationSummaryActivity.this, UniversityDetailActivity.class);
            ...
            baseRepository.getUniversity(universityId).observe(this, new Observer<University>() {
                ...
                public void onChanged(University university) {
                    if (university != null) {
                        ...
                        binding.reportCourse.setText(researchTitle);
